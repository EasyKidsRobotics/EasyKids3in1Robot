...
<<<<< Command >>>>>
  ...
  lineTrackTime (Speed, KP, KD, Time);
  lineTrackCross(Speed, KP, KD);
...
void loop() {
  ...
  waitForStart(); 
  beep(); 
  lineTrackTime(20, 1.0, 1.0, 1000); //lineTrackTime (Speed, KP, KD, Time(ms));
  lineTrackCross(30, 1.0, 1.0); //lineTrackCross(Speed, KP, KD);
  lineTrackTime(35, 1.0, 1.0, 5000); //lineTrackTime (Speed, KP, KD, Time(ms));
